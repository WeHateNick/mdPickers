    ...
    return {
        ...
        template: '<div class="mdp-calendar">' +
                    '<div layout="row" layout-align="space-between center">' +
                        ...
                        '<div class="mdp-calendar-monthyear" ng-show="!calendar.animating">{{ calendar.date.format("MMMM") }} <span ng-click="datepicker.showYear()">{{ calendar.date.format("YYYY") }}</span></div>' +
